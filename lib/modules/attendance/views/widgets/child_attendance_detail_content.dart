...
class ChildAttendanceDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        _buildSubjectAttendanceCard(context),
        if (onDownload != null) ...[
  ...
  Widget _buildHeroCard(BuildContext context) {
    ...
    final initials = summary.childName.isNotEmpty
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              if (presentCount == 0 && absentCount == 0 && pendingCount == 0)
                Text(
                  'No attendance submissions are available yet.',
                  style: theme.textTheme.bodyMedium?.copyWith(
  ...
  Widget _buildSubjectAttendanceCard(BuildContext context) {
    final theme = Theme.of(context);
